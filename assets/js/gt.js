window.initGeetest = (function (e) {
  ...
  function (e, t, s) {
    ...
    (i.prototype = {
      ...
      _map: function (e) {
        ...
        for (var s = [], n = 0, o = t.length; n < o; n += 1)
          s[n] = e(t[n], n, this);
        return new i(s);
      },
      _filter: function (e) {
      ...
      _forEach: function (e) {
        var t = this,
          s = t._arr;
        if (!s.forEach)
          for (var n = arguments[1], o = 0; o < s.length; o++)
            o in s && e.call(n, s[o], o, t);
        return s.forEach(e);
      },
    }),
      ...
      (l.prototype = {
        ...
        _toggleClass: function (e) {
          ...
          return (
            -1 ===
            new i(s.className ? s.className.split(" ") : [])._indexOf(a + e)
              ? t._addClass(e)
              : t._removeClass(e),
            t
          );
        ...
        _addClass: function (e) {
          ...
          return (
            (e = a + e),
            -1 == s._indexOf(e) && (s._push(e), (t.className = s._join(" "))),
            this
          );
        },
        ...
        _replaceClass: function (e, t) {
          return this._removeClass(t)._addClass(e), this;
        },
        ...
        _addEvent: function (e, t) {
          var s = this,
            n = s._addEvent0(e, t);
          return (
            (s._eventHandlers = s._eventHandlers || {}),
            s._eventHandlers[e]
              ? s._eventHandlers[e].push(n)
              : (s._eventHandlers[e] = [n]),
            s
          );
        },
        _removeEvents: function (e) {
          ...
          if (t._eventHandlers)
            if (e) {
              if (t._eventHandlers[e] && t._eventHandlers[e].length > 0)
                for (var s = t._eventHandlers[e].length - 1; s >= 0; s--)
                  t._eventHandlers[e][s]._destroy();
            } else
              for (var n in t._eventHandlers)
                if (t._eventHandlers[n] && t._eventHandlers[n].length > 0)
                  for (s = t._eventHandlers[n].length - 1; s >= 0; s--)
                    t._eventHandlers[n][s]._destroy();
          return t;
        },
        ...
        _clone: function (e) {
          ...
          } else (t = new l(n._ele.cloneNode(!1)))._addClass("sandbox");
          return t;
        },
        _click: function () {
        ...
        _fixOverflow: function () {
          ...
          try {
            for (
              ...
              n.offsetTop - o.parentNode.offsetTop < 160;
                  ...
                  (e = o).currentStyle
                    ...
                    : window.getComputedStyle &&
                      (s = window
                        ...
                        .getPropertyValue(t)),
                  s) && (o.style.overflow = "visible");
          } catch (r) {}
          return this;
        },
        _getElementLeft: function () {
          for (
            var e = this._ele, t = e.offsetLeft, s = e.offsetParent;
            null !== s;
        ...
        _getElementTop: function () {
          for (
            var e = this._ele, t = e.offsetTop, s = e.offsetParent;
            null !== s;
      ...
      (l.$ = function (e) {
        ...
        "string" == typeof e
          ? "#" === e[0]
            ...
            : r(window.jQuery) && (t = window.jQuery(e)[0])
          : (t = e.length ? e[0] : e);
        try {
          s = Node.ELEMENT_NODE;
        } catch (n) {
      ...
      (g.prototype = {
        ...
        _preventDefault: function () {
          var e = this._e;
          return (
            e.cancelable && r(e.preventDefault)
              ? e.preventDefault()
              : (e.returnValue = !1),
            this
          );
  ...
  function (e, t, s) {
    ...
    e.exports = {
      ...
      getCSS3: function () {
        return (
          !!o &&
          ("transition" in o.style ||
            "webkitTransition" in o.style ||
            "mozTransition" in o.style ||
            "msTransition" in o.style)
        );
      },
      body: o,
      IE6: i,
  ...
  function (e, t, s) {
      ...
      u = function (e, t, s, n, r, i, _) {
        !(function l(g) {
          !(function (e, t) {
            ...
            (s.charset = "UTF-8"),
              (s.async = !0),
              /static\.geetest\.com/g.test(e) && (s.crossOrigin = "anonymous"),
              (s.onerror = function () {
                t(!0);
              });
            var n = !1;
    ...
    e.exports = function (e, t) {
      ...
      e.https
        ? (s.protocol = "https://")
        : e.protocol || (s.protocol = window.location.protocol + "//"),
        ("050cffef4ae57b5d5e529fea9540b0d1" !== e.gt &&
          "3bd38408ae4af923ed36e13819b14d42" !== e.gt) ||
          ((s.apiserver = "yumchina.geetest.com/"),
          (s.api_server = "yumchina.geetest.com")),
        e.gt && (window.GeeGT = e.gt),
        e.challenge && (window.GeeChallenge = e.challenge),
        l(e.getType) && s._extend(e.getType),
        f([s.api_server || s.apiserver], s.typePath, s, function (e) {
          var o = e.type;
    ...
    (x.prototype = {
      _init: function () {
        ...
        "float" !== e.product &&
          ...
          "bind" !== e.product &&
          (e.product = "float"),
          o && "float" === e.product && (e.product = "popup"),
          (this._ui = new a(this));
      },
      ...
      _onStatusChange: function (e, t) {
        ...
        if (!n._equal(t) && t !== m)
          if (
            (n._equal(w) || (s && s._onChangeStatus(e, t), s && s._tip()),
            n._equal(w))
          )
            ...
            a && !r.pure && s._panelShowLoading(), s._compute();
      ...
      _verify: function () {
        ...
        "bind" === t.product &&
          (s._equal(l)
            ...
            : s._equal(h)
            ? s._set(f)
            : s._equal([p, d]) && (e && e._reset(), s._set(c)));
      },
  ...
  function (e, t, s) {
    ...
    function D(e) {
      ...
      (s._status = e._status),
        (s._captcha = e),
        (s._config = r),
        (s._userConfig = e._userConfig),
        (s._lang = n(r)),
        (s.$ = o()),
        (s._css3 = _()),
        (s._css3_move = null),
        (s._setDelay = function (e) {
          return s._css3 ? e : 0;
        }),
        (t = s._css3 ? ".holder." + r.theme : ".holder.ie." + r.theme),
        r.offline && (t += ".fallback"),
        (s._dom = g(t, c, s.$)),
        (s._win = new u(window)),
        (s._doc = new u(document)),
        s._init();
    }
    (D.prototype = {
      _WIDTH: 260,
        ...
        if (s) {
          ...
          if (
            ...
            if (
              ...
              s(".success_radar_tip_content")._text(e[n]);
            else if (t._equal([S])) {
              ...
              if (o && o.code) {
                var r = this._config,
                  a = /(\d+)$/.exec(o.code);
                "bind" === r.product
                  ? (s(".panel_error_title")._text(o.user_error || ""),
                    a && s(".panel_error_code_text")._text(a[0] || ""))
                  : (s(".radar_tip_content")._text(o.user_error || ""),
                    a && s(".radar_error_code")._text(a[0] || ""));
              } else s(".radar_tip_content")._text(e[n]);
            } else s(".radar_tip_content")._text(e[n]);
            this._errorTip &&
              t._equal(S) &&
              (s(".radar_tip_content")._text("error"), (this._errorTip = !1));
          }
        }
      },
      _init: function () {
            ...
            : (a && s.logo) ||
              (s.logo
                ? (t(".logo")._setProps({
                  ...
                  t(".success_logo")._setProps({
                    target: "_blank",
                    href: s.homepage,
                  }))
                : (t(".logo")._hide(), t(".success_logo")._hide())),
          s.logo && a && "bind" !== s.product
            ? (t(".goto")._addClass(s.theme)._moveTo(new u(m)),
              t(".goto_content_tip")._text(n.goto_homepage),
              t(".goto_confirm")._text(n.goto_confirm)._setProps({
                href: s.homepage,
              }),
              t(".goto_cancel")._text(n.goto_cancel),
              t(".goto")._hide())
            : t(".goto")._hide(),
          "bind" === s.product &&
            (t(".panel")._hide()._addClass(s.theme)._moveTo(new u(m)),
            s.offline && t(".panel")._addClass("fallback"),
            e._css3 || t(".panel")._addClass("ie"),
            t(".panel_loading_content")._text(n.loading_content),
            t(".panel_success_title")._text(n.success_title),
            t(".panel_error_title")._text(n.error_title),
            t(".panel_error_content")._text(n.error_content),
            t(".panel_footer_copyright")._text(n.copyright),
            t(".panel_ghost")._addEvent("click", function () {
              r._equal([z, S])
                ? (e._panelHide(), r._equal(S) && o._closePanel())
                : r._equal(O) && r._set(P);
            })),
          "bind" !== s.product &&
            new f(["ar", "fa", "iw", "ur"])._indexOf(s.lang) > -1 &&
            (t(".radar_tip")._addClass("reversal"),
            t(".success_radar_tip")._addClass("reversal_success")),
          t(".reset_tip_content")._text(n.reset),
          e
        );
      },
      _addEvent: function () {
        ...
        (n._logo_click = !1),
          a
            ? (new f([o(".logo"), o(".success_logo")])._map(function (e) {
              ...
              new f([o(".goto_cancel"), o(".goto_ghost")])._map(function (e) {
                e._addEvent("click", function () {
                  (n._logo_click = !1),
                    o(".goto")._opacity(0),
                    setTimeout(function () {
            ...
            : (o(".logo")._addEvent("click", function (e) {
                (n._logo_click = !0),
                  setTimeout(function () {
                    n._logo_click = !1;
                  }, 10);
              }),
              o(".success_logo")._addEvent("click", function (e) {
                (n._logo_click = !0),
                  setTimeout(function () {
                    n._logo_click = !1;
                  }, 10);
          ...
          n._css3 &&
            ((n._css3_move =
              ...
              s)),
            n._doc._addEvent("move", n._css3_move));
        var _ = function () {
          n._logo_click ||
            (("function" != typeof n._captcha._validateCallback ||
              n._captcha._validateCallback()) &&
              (r._equal([A, y, T])
                ? (r._set(v),
                  setTimeout(function () {
                    r._equal(v) && (r._set(C), n._fullpage());
                  }, 10))
                : r._equal([x]) && (r._set(C), n._fullpage())));
        };
        return (
          o(".holder")
          ...
          o(".reset_tip_content")._addEvent("click", function () {
            n._captcha._errObj && "error_21" === n._captcha._errObj.code
              ? n._refreshPage()
              : n._reset()._then(function () {
                  r._set(E);
                });
          }),
          n
      ...
      _reset: function () {
        ...
        e._set(N),
          this._captcha._resetValidate(),
          s === z &&
            (this._clearForm(),
            t(".ghost_success")._hide(),
            this._css3 &&
              setTimeout(function () {
                t(".ghost_success")._removeClass("success_animate")._show();
              }, 10)),
          e._set(x);
      },
      _zoom: function () {
      ...
      _onChangeStatus: function (e, t) {
        var s = this.$;
        if (e === z)
          if ((s(".holder")._replaceClass(e, t || null), this._css3))
            s(".ghost_success")._addClass("success_animate"),
              s(".panel_success")._addClass("success_animate"),
              s(".success_btn")._setStyles({
                width: s(".holder")._width() + "px",
              }),
              setTimeout(function () {
                s(".success_btn")._setStyles({
                  width: "100%",
            ...
            var n = this._config;
            ("bind" === n.product && n.pure) ||
              (s(".panel_success")._show()._addClass("success_animate"),
              s(".ghost_success")._show()._addClass("success_animate"));
          }
        else s(".holder")._replaceClass(e, t || null);
        return this;
      },
      _appendTo: function (e) {
        this._config;
        return (
          this._box ||
            ...
            ((this._box = u.$(e)),
            this._addEvent(),
            this._dom._appendTo(this._box)),
          this
        );
      },
      _bindForm: function (e) {
        var t = this.$;
        if (((this._form = u.$(e)), this._form))
          return t(".form")._moveTo(this._form), this;
      },
      ...
      _success: function (e) {
        var t = this,
          s = t._config;
        "bind" === s.product &&
          (s.pure || (t._panelShowSuccess(), t._panelRemove())),
          t._setForm(e);
      },
      _setForm: function (e) {
        var t = this.$;
        t(".challenge")._setAttrs({
          value: e.geetest_challenge,
        }),
          t(".validate")._setAttrs({
      ...
      _clearForm: function () {
        var e = this.$;
        return (
          e(".challenge")._removeAttrs(["value"]),
          e(".validate")._removeAttrs(["value"]),
          e(".seccode")._removeAttrs(["value"]),
          this
        );
      },
      _panelShow: function () {
        var e = this.$;
        e(".panel_loading")._hide(),
          e(".panel_success")._hide(),
          e(".panel_error")._hide(),
          e(".panel_footer")._hide(),
          e(".panel_next")._hide(),
          e(".panel")._show(),
          setTimeout(function () {
            e(".panel")._opacity(1);
      ...
      _panelRemove: function () {
        var e = this.$;
        e(".panel_box")._removeClass("panelshowclick"),
          e(".panel_box")._removeClass("ie6panelshowclick"),
          e(".panel_box")._removeClass("panelshowslide"),
          e(".panel_box")._removeClass("panelshowbeeline"),
          e(".panel_box")._setStyles({
            width: "",
            height: "",
          });
      ...
      _destroy: function () {
        var e = this._config,
          t = this.$;
        switch (
          (this._win._removeEvents(),
          this._doc._removeEvents(),
          this._css3_move && this._css3_move.cancel(),
          e.product)
        ) {
          case "bind":
            t(".panel")._remove();
          ...
          case "popup":
          case "float":
            t(".holder")._remove(), t(".fullpage_click")._remove();
            break;
          case "custom":
            t(".holder")._remove();
        }
      ...
      _panelShowPanel: function () {
        var e = this.$;
        this._panelShow(), e(".panel_next")._hide();
      },
      _panelShowLoading: function () {
        var e = this.$;
        this._config.area && this._panelBindLoading(),
          this._panelShowPanel(),
          e(".panel_loading")._show(),
          this._show_panel_footer();
      },
      ...
      _panelShowSuccess: function () {
        var e = this.$;
        this._panelShowPanel(),
          e(".panel_success")._show(),
          this._show_panel_footer();
      },
      _show_panel_footer: function () {
        var e = this.$;
        this._config.logo
          ? e(".panel_footer")._show()
          : (e(".panel_box")._addClass("no_logo"), e(".panel_footer")._hide());
      },
  ...
  function (e, t, s) {
    ...
    e.exports = function (e) {
      var t,
        ...
        o = {
          "zh-cn":
            ...
            (t.error = "网络故障"),
            (t.goto_homepage = "是否前往验证服务Geetest官网？"),
            (t.goto_confirm = "前往"),
            (t.goto_cancel = "取消"),
            (t.loading_content = "智能验证检测中"),
            (t.success_title = "通过验证"),
            (t.error_title = "网络超时"),
            (t.error_content = "请点击此处重试"),
            (t.copyright = "由极验提供技术支持"),
            (t.refresh_page = "页面出现错误啦！要继续操作，请刷新此页面。"),
            t),
          en: {
            ready: "Click to pass",
            fullpage: "Detecting",
      ...
      for (var r in s)
        if ("object" == typeof s && s.hasOwnProperty(r)) return s;
      return e &&
        e.offline &&
        new n(["zh-cn", "en", "zh-hk"])._indexOf(e.lang) > -1
        ? o[e.lang]
        : o["zh-cn"];
    };
  },
  ...
  function (e, t, s) {
    ...
    (o.prototype = {
      _set: function (e) {
        var t = this;
        return (
          (t._prevStatus = t._status),
          (t._status = e),
          t._onChange(t._status, t._prevStatus),
          t
        );
      },
      _get: function () {
      ...
      _equal: function (e) {
        for (
          var t = n._isArray(e) ? e : [e], s = 0, o = t.length;
          s < o;
          s += 1
        )
          if (t[s] === this._get()) return !0;
        return !1;
      },
    }),
      (e.exports = o);
